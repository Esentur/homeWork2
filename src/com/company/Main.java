...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int rnd = generateRandomAge(max);//присваиваем значение полученное в методе переменному rnd
        System.out.println("Случайное число(0-107): " + rnd);// вывод в консоль значение перменной rnd
